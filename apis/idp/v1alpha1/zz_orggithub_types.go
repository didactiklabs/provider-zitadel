...
type OrgGithubInitParameters struct {
...
type OrgGithubObservation struct {
...
type OrgGithubParameters struct {
...
// OrgGithubSpec defines the desired state of OrgGithub
type OrgGithubSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrgGithubParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrgGithubInitParameters `json:"initProvider,omitempty"`
}

// OrgGithubStatus defines the observed state of OrgGithub.
type OrgGithubStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrgGithubObservation `json:"atProvider,omitempty"`
}
...
// OrgGithub is the Schema for the OrgGithubs API. Resource representing a GitHub IdP on the organization.
...
type OrgGithub struct {
	...
	Spec   OrgGithubSpec   `json:"spec"`
	Status OrgGithubStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrgGithubList contains a list of OrgGithubs
type OrgGithubList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrgGithub `json:"items"`
}

// Repository type metadata.
var (
	OrgGithub_Kind             = "OrgGithub"
	OrgGithub_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrgGithub_Kind}.String()
	OrgGithub_KindAPIVersion   = OrgGithub_Kind + "." + CRDGroupVersion.String()
	OrgGithub_GroupVersionKind = CRDGroupVersion.WithKind(OrgGithub_Kind)
)

func init() {
	SchemeBuilder.Register(&OrgGithub{}, &OrgGithubList{})
}
