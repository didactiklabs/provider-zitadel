...
type InstanceGoogleInitParameters struct {
...
type InstanceGoogleObservation struct {
...
type InstanceGoogleParameters struct {
...
// InstanceGoogleSpec defines the desired state of InstanceGoogle
type InstanceGoogleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     InstanceGoogleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider InstanceGoogleInitParameters `json:"initProvider,omitempty"`
}

// InstanceGoogleStatus defines the observed state of InstanceGoogle.
type InstanceGoogleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        InstanceGoogleObservation `json:"atProvider,omitempty"`
}
...
// InstanceGoogle is the Schema for the InstanceGoogles API. Resource representing a Google IDP on the instance.
...
type InstanceGoogle struct {
	...
	Spec   InstanceGoogleSpec   `json:"spec"`
	Status InstanceGoogleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// InstanceGoogleList contains a list of InstanceGoogles
type InstanceGoogleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []InstanceGoogle `json:"items"`
}

// Repository type metadata.
var (
	InstanceGoogle_Kind             = "InstanceGoogle"
	InstanceGoogle_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: InstanceGoogle_Kind}.String()
	InstanceGoogle_KindAPIVersion   = InstanceGoogle_Kind + "." + CRDGroupVersion.String()
	InstanceGoogle_GroupVersionKind = CRDGroupVersion.WithKind(InstanceGoogle_Kind)
)

func init() {
	SchemeBuilder.Register(&InstanceGoogle{}, &InstanceGoogleList{})
}
