...
type OrgGoogleInitParameters struct {
...
type OrgGoogleObservation struct {
...
type OrgGoogleParameters struct {
...
// OrgGoogleSpec defines the desired state of OrgGoogle
type OrgGoogleSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OrgGoogleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OrgGoogleInitParameters `json:"initProvider,omitempty"`
}

// OrgGoogleStatus defines the observed state of OrgGoogle.
type OrgGoogleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OrgGoogleObservation `json:"atProvider,omitempty"`
}
...
// OrgGoogle is the Schema for the OrgGoogles API. Resource representing a Google IdP on the organization.
...
type OrgGoogle struct {
	...
	Spec   OrgGoogleSpec   `json:"spec"`
	Status OrgGoogleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OrgGoogleList contains a list of OrgGoogles
type OrgGoogleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OrgGoogle `json:"items"`
}

// Repository type metadata.
var (
	OrgGoogle_Kind             = "OrgGoogle"
	OrgGoogle_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OrgGoogle_Kind}.String()
	OrgGoogle_KindAPIVersion   = OrgGoogle_Kind + "." + CRDGroupVersion.String()
	OrgGoogle_GroupVersionKind = CRDGroupVersion.WithKind(OrgGoogle_Kind)
)

func init() {
	SchemeBuilder.Register(&OrgGoogle{}, &OrgGoogleList{})
}
