...
PROJECT_REPO ?= github.com/didactiklabs/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-zitadel_2.12.5
...
REGISTRY_ORGS ?= xpkg.upbound.io/banhcanh
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/banhcanh
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/banhcanh
XPKGS = $(PROJECT_NAME)
...
#   You can check the basic implementation here: https://github.com/crossplane/uptest/blob/main/internal/zitadels/03-delete.yaml.tmpl.
